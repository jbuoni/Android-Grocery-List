...
public class GroceryListControllerUnitTest {
    ...
    public void init() {
        ...
        item2 = new ListItem(2, new Item(2, "Test Item 2", 1), false, 1);
        item3 = new ListItem(3, new Item(2, "Test Item 3", 1), false, 1);


    }

    @Test
    public void updateCurrentList_isCorrect() throws Exception {
